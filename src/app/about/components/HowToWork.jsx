                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="flex flex-col gap-8 lg:pl-8">
                        ...
                        <ol className="flex flex-col gap-5 text-[15px] sm:text-[16px] leading-[1.6] text-slate-600 list-decimal list-outside pl-4">
                            <li className="pl-2">
                                <strong className="text-slate-900 font-medium tracking-tight">Simple Sign-Up :</strong> Get started by accepting a referral link from our marketing team, sharing it on social media, or visiting our website www.paynback.in. Download and install PayNback app from play store.
                            </li>
                            <li className="pl-2">
