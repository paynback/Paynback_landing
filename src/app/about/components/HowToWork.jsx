...
export default function HowToWork() {
  ...
  return (
    <section className="w-full bg-white font-['Poppins'] pt-16 pb-42 lg:pb-50">
      <div className="mx-auto max-w-7xl px-4 sm:px-8 lg:px-10 space-y-24 lg:space-y-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          ...
          <div className="flex flex-col lg:pt-[4.5rem]">
            <p className="text-[15px] sm:text-[16px] leading-[1.8] text-slate-600 font-normal">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative w-full aspect-[4/5] sm:aspect-[571/439] max-w-[571px] rounded-[16px] bg-gradient-to-tr from-[#2b4fa8] to-[#86b5e5] flex items-end justify-center shadow-xl mx-auto lg:mx-0 overflow-hidden pt-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="relative w-full aspect-[4/5] sm:aspect-[571/439] max-w-[571px] rounded-[16px] bg-gradient-to-tr from-[#2b4fa8] to-[#86b5e5] flex items-end justify-center shadow-xl mx-auto lg:mx-0 overflow-hidden pt-12 order-last lg:order-first">
            <div className="relative z-10 w-[85%] sm:w-[65%] lg:w-[60%] h-[95%]">
               <Image src={IMG_TWO_HANDS} fill className="object-contain object-bottom" alt="App with two hands" />
            </div>
          </div>
