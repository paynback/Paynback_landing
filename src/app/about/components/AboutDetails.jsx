      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24 flex flex-col gap-16 lg:gap-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
          ...
          <div className="flex flex-col gap-6">
            <h2 className="text-[48px] font-medium leading-[124%] tracking-[-0.56px] text-slate-900 font-['Poppins']">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col gap-8">
            <h3 className="text-[32px] font-medium leading-[124%] tracking-[-0.56px] text-slate-900 font-['Poppins']">
