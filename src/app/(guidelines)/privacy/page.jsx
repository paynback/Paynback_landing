...
const TOC_ITEMS = [
  ...
  { id: "message-policy", label: "Message Policy" },
  { id: "retention", label: "Retention of Data" },
...
export default function PrivacyPolicyPage() {
  return (
    ...
    >
      ...
      <Section id="interpretation" number="2" title="Interpretation and Definitions">
        <SubSection number="2.1" title="Interpretation">
          <p>
        ...
        <SubSection number="2.2" title="Definitions">
          <p>For the purposes of this Privacy Policy:</p>
          <ul className="list-disc space-y-2 pl-5 marker:text-[#4EA8E9]">
            <li>
              <strong className="text-white/90">Account</strong> means a unique account created for
              You to access our Service or parts of our Service.
            </li>
            <li>
              <strong className="text-white/90">Affiliate</strong> means an entity that controls, is
            ...
            <li>
              <strong className="text-white/90">Application</strong> refers to PayNback, the software
              program provided by the Company.
            </li>
            <li>
              <strong className="text-white/90">Company</strong> (referred to as either &quot;the
              Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement)
              refers to PayNback LLP, Cochin, Kerala, India 682030.
            </li>
            <li>
              <strong className="text-white/90">Cookies</strong> are small files that are placed on
              Your computer, mobile device or any other device by a website, containing the details of
              Your browsing history on that website among its many uses.
            </li>
            <li>
              <strong className="text-white/90">Country</strong> refers to: Kerala, India
            </li>
            <li>
              <strong className="text-white/90">Device</strong> means any device that can access the
              Service such as a computer, a cellphone or a digital tablet.
            </li>
            <li>
              <strong className="text-white/90">Personal Data</strong> is any information that
              relates to an identified or identifiable individual.
            </li>
            <li>
              <strong className="text-white/90">Service</strong> refers to the Application or the
              Website or both.
            </li>
            <li>
              <strong className="text-white/90">Service Provider</strong> means any natural or legal
              person who processes the data on behalf of the Company. It refers to third-party
              companies or individuals employed by the Company to facilitate the Service, to provide
              the Service on behalf of the Company, to perform services related to the Service or to
              assist the Company in analyzing how the Service is used.
            </li>
            <li>
              <strong className="text-white/90">Usage Data</strong> refers to data collected
              automatically, either generated by the use of the Service or from the Service
              infrastructure itself (for example, the duration of a page visit).
            </li>
            <li>
              <strong className="text-white/90">Website</strong> refers to PayNback, accessible from{" "}
              https://paynback.com
            </li>
            <li>
              <strong className="text-white/90">You</strong> means the individual accessing or using
      ...
      <Section id="information-collected" number="3" title="Information We Collect">
        <SubSection number="3.1" title="Personal Data">
          <p>
        ...
        <SubSection number="3.2" title="Usage Data">
        ...
        <SubSection number="3.3" title="Information Collected while Using the Application">
          <p>
      ...
      <Section id="tracking-cookies" number="4" title="Tracking Technologies and Cookies">
        <p>
        ...
        <ul className="list-disc space-y-3 pl-5 marker:text-[#4EA8E9]">
          <li>
            <strong className="text-white/90">Cookies or Browser Cookies.</strong> A cookie is a small
          ...
          <li>
            <strong className="text-white/90">Web Beacons.</strong> Certain sections of our Service
            and our emails may contain small electronic files known as web beacons (also referred to
            as clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for example,
        ...
        <div className="space-y-6 pt-2">
          <div>
            <h4 className="mb-1 font-medium text-white/90">Necessary / Essential Cookies</h4>
            <p className="mb-2 text-xs text-[#4EA8E9]">Type: Session Cookies | Administered by: Us</p>
            <p>
          ...
          <div>
            <h4 className="mb-1 font-medium text-white/90">
              Cookies Policy / Notice Acceptance Cookies
            </h4>
            <p className="mb-2 text-xs text-[#4EA8E9]">Type: Persistent Cookies | Administered by: Us</p>
            <p>These Cookies identify if users have accepted the use of cookies on the Website.</p>
          </div>
          <div>
            <h4 className="mb-1 font-medium text-white/90">Functionality Cookies</h4>
            <p className="mb-2 text-xs text-[#4EA8E9]">Type: Persistent Cookies | Administered by: Us</p>
            <p>
      ...
      <Section id="use-of-data" number="5" title="Use of Your Personal Data">
        <p>The Company may use Personal Data for the following purposes:</p>
        <ul className="list-disc space-y-3 pl-5 marker:text-[#4EA8E9]">
          <li>
            <strong className="text-white/90">To provide and maintain our Service</strong>, including
            to monitor the usage of our Service.
          </li>
          <li>
            <strong className="text-white/90">To manage Your Account:</strong> to manage Your
          ...
          <li>
            <strong className="text-white/90">For the performance of a contract:</strong> the
          ...
          <li>
            <strong className="text-white/90">To contact You:</strong> To contact You by email,
          ...
          <li>
            <strong className="text-white/90">To provide You</strong> with news, special offers and
          ...
          <li>
            <strong className="text-white/90">To manage Your requests:</strong> To attend and manage
            Your requests to Us.
          </li>
          <li>
            <strong className="text-white/90">For business transfers:</strong> We may use Your
          ...
          <li>
            <strong className="text-white/90">For other purposes:</strong> We may use Your
            information for other purposes, such as data analysis, identifying usage trends,
            determining the effectiveness of our promotional campaigns and to evaluate and improve
        ...
        <ul className="list-disc space-y-3 pl-5 marker:text-[#4EA8E9]">
          <li>
            <strong className="text-white/90">With Service Providers:</strong> We may share Your
            personal information with Service Providers to monitor and analyze the use of our
            Service, to contact You.
          </li>
          <li>
            <strong className="text-white/90">For business transfers:</strong> We may share or
          ...
          <li>
            <strong className="text-white/90">With Affiliates:</strong> We may share Your information
          ...
          <li>
            <strong className="text-white/90">With business partners:</strong> We may share Your
            information with Our business partners to offer You certain products, services or
            promotions.
          </li>
          <li>
            <strong className="text-white/90">With other users:</strong> when You share personal
          ...
          <li>
            <strong className="text-white/90">With Your consent:</strong> We may disclose Your
            personal information for any other purpose with Your consent.
          </li>
        </ul>
      </Section>

      <Section id="message-policy" number="6" title="Message Policy">
        <p>
          We also reserve the right to send service-related and promotional messages through SMS,
          WhatsApp, RCS, or phone calls, when required, for the purpose of providing our services,
          updates, offers, or important account-related information.
        </p>
      </Section>

      <Section id="retention" number="7" title="Retention of Data">
        <p>
      ...
      <Section id="transfer" number="8" title="Transfer of Data">
        <p>
      ...
      <Section id="disclosure" number="9" title="Disclosure of Personal Data">
        <SubSection number="9.1" title="Delete Your Personal Data">
          <p>
          ...
          <p>
            ...
            Account, if you have one, and visiting the account settings section. You may also contact
            Us to request access to, correct, or delete any personal information that You have
            provided to Us.
          </p>
        </SubSection>
        <SubSection number="9.2" title="Business Transactions">
          <p>
        ...
        <SubSection number="9.3" title="Law enforcement">
          <p>
        ...
        <SubSection number="9.4" title="Other legal requirements">
          <p>
      ...
      <Section id="other-policies" number="12" title="Other Policies">
        <SubSection number="12.1" title="Links to Other Websites">
          <p>
        ...
        <SubSection number="12.2" title="Changes to this Privacy Policy">
          <p>
            We may update Our Privacy Policy from time to time. We will notify You of any changes by
            posting the new Privacy Policy on this page and update the &quot;Last updated&quot; date
