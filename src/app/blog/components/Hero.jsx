    ...
    <section className="relative isolate min-h-screen w-full flex flex-col overflow-hidden bg-black font-sans text-white">
      ...
      <div className="relative z-10 mx-auto flex w-full flex-1 max-w-7xl flex-col px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative flex-1 flex flex-col justify-between pt-10 pb-8 sm:pb-12 xl:pb-16 w-full">
          ...
          <div className="w-full flex flex-col justify-center mt-12 sm:mt-24 lg:mt-32 relative z-30">
            <span className="text-[24px] font-normal leading-[124%] tracking-[-0.56px] font-['Poppins'] mb-8 drop-shadow-md">Blogs</span>
            ...
            <p className="whitespace-nowrap font-normal text-[18px] leading-[124%] tracking-[-0.56px] font-['Poppins'] text-white/90 drop-shadow-md">
          ...
          <div className="absolute right-0 bottom-[-3%] top-10 w-full lg:w-[65%] xl:w-[60%] pointer-events-none z-20 flex justify-end items-end overflow-hidden sm:overflow-visible">
            ...
            <div className="absolute right-[2%] bottom-[-20%] w-[110%] h-[110%] opacity-20 lg:opacity-30 z-0">
              <Image
                src={IMG_BIG_LOGO}
                alt="Big PayNBack Logo"
                fill
                className="object-contain object-right-bottom transform rotate-[-5deg] scale-125"
                priority
              />
            </div>
            {/* Hand Image */}
