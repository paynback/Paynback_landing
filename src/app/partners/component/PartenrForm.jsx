    ...
    return (
        <div className="relative" ref={selectRef}>
            ...
            >
                ...
                <svg className={`fill-current h-4 w-4 transition-transform shrink-0 ${isOpen ? 'rotate-180' : ''} ${error ? 'text-red-500' : 'text-gray-500'}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
